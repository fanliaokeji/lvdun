...
function System_Button_SetAlpha(self, alpha)
	local miniobj = self:GetControlObject("Kuaikan.System.Button.Mini")
	local maxObj = self:GetControlObject("Kuaikan.System.Button.Max")
	local closeObj = self:GetControlObject("Kuaikan.System.Button.Close")
	if miniobj then
		miniobj:SetAlpha(alpha)
	end
	if maxObj then
		maxObj:SetAlpha(alpha)
	end
	if closeObj then
		closeObj:SetAlpha(alpha)
	end
end
...
function System_Button_Max_OnClick(self)
	...
	local maxObj = owner:GetControlObject("Kuaikan.System.Button.Max")
	local maxObjattr = maxObj:GetAttribute()
...
function System_Button_Ctrl_OnBind(self)
	...
	if attr.MiniShow then
	    miniobj = xarFactory:CreateUIObject("Kuaikan.System.Button.Mini", "Kuaikan.System.ItemEx")
	...
	if attr.MaxShow then
	    maxobj = xarFactory:CreateUIObject("Kuaikan.System.Button.Max", "Kuaikan.System.ItemEx")
	...
	if attr.CloseShow then
	    closeobj = xarFactory:CreateUIObject("Kuaikan.System.Button.Close", "Kuaikan.System.ItemEx")
...
function System_Item_SetAlpha(self, alpha)
	local bkgObj = self:GetControlObject("layout.texture")
	local imageObj = self:GetControlObject("item.bkg.image")
	local oldImageObj = self:GetControlObject("old.image")
	bkgObj:SetAlpha(alpha)
	imageObj:SetAlpha(alpha)
	oldImageObj:SetAlpha(alpha)
end
