...
{
    LuaNotifyIcon** ppNotifyIcon = (LuaNotifyIcon **)luaL_checkudata(pLuaState, 1, LUA_NOTIFYICON_CLASS);
...
void LuaNotifyIcon::RegisterSelf(XL_LRT_ENV_HANDLE hEnv)
{
    ...
    XLLRTObject object;
    object.ClassName = LUA_NOTIFYICON_CLASS;
    object.ObjName = LUA_NOTIFYICON_OBJ;
