...
//		_sntprintf(szMutex, _MAX_PATH, _T("#mutex%s_%s"), _T("DD_{10808D97-3494-4c5d-857F-0ADFA04FA722}"),_T("1.0"));
...
//			
//			HWND hWnd = ::FindWindow(_T("{10808D97-3494-4c5d-857F-0ADFA04FA722}_ddnotepadmsg"), NULL);
//			if(hWnd)
//			{
