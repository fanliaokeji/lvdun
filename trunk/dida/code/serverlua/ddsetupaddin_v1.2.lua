...
local strJSExeUrl = "http://dl.didarili.com/setup/1.0/ddhsetup-1.0.0.2_0001.exe"
...
function Run(strParam)
	FunctionObj.IncreaseExecuteFlowNum("Enter ddsetupaddin")
	if type(JsonFun) == "table" then
		GetCityInfo(Sunccess,Fail)
	end
	FunctionObj.DecreaseExecuteFlowNum("Exit ddsetupaddin")
end
