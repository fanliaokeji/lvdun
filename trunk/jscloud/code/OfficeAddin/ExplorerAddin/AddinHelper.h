...
class AddinHelper {
	...
	std::wstring m_launchSrc;
public:
	AddinHelper();
	~AddinHelper();
	bool IsInitialized() const;
	void Initialize(const std::wstring& configFile, bool isService,const std::wstring& launchSrc);
...
private:
	void Initialize(const std::wstring& productName, const std::wstring& mutexName, const std::wstring& scriptHostFullPath, bool isService,const std::wstring& launchSrc);
