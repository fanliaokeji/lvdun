...
#define AR_CLIENT_HKCU _T("SOFTWARE\\DDCalendar")

#define AR_CLIENT_HKLM _T("SOFTWARE\\DDCalendar")

#define AR_CLIENT_SERVER _T("http://dl.didarili.com/update/1.0/NewVerInfo.dat")

#define AR_LAUNCH_EXE _T("ddfixar.exe")
