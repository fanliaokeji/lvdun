...
#define APP_DS_MAGIC 0x0802
	...
	if(iSingleTon)
	{
		...
		_sntprintf(szMutex, _MAX_PATH, _T("#mutex%s_%s"), _T("Eraser_{D8BD00DC-74BF-45ad-B8CB-61CB31C2CE84}"),_T("1.0"));
		...
		if(bExist)
		{
			...
			HWND hWnd = ::FindWindow(_T("{D8BD00DC-74BF-45ad-B8CB-61CB31C2CE84}_weberaser"), NULL);
			if(hWnd)
			{
