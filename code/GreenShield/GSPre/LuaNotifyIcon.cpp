...
#include "..\GreenShield\resource.h"
...
{
    LuaNotifyIcon** ppNotifyIcon = (LuaNotifyIcon **)luaL_checkudata(pLuaState, 1, XMPTIPWND_NOTIFYICON_CLASS);
...
void LuaNotifyIcon::RegisterSelf(XL_LRT_ENV_HANDLE hEnv)
{
    ...
    XLLRTObject object;
    object.ClassName = XMPTIPWND_NOTIFYICON_CLASS;
    object.ObjName = XMPTIPWND_NOTIFYICON_OBJ;
