...
int LuaGSUtil::FGSFilter(lua_State* pLuaState)
{
	...
	if (bFilter)
	{
		...
		if (!bOnce)
		{	
			if (GsSetHook(L"GsFilterHelp.dll"))
			{
...
int LuaGSUtil::Encrypt_AES_BASE64(lua_State* pLuaState)
{
	LuaGSUtil** ppGSUtil = (LuaGSUtil **)luaL_checkudata(pLuaState, 1, GS_UTIL_CLASS);
	if (ppGSUtil != NULL)
	{
...
int LuaGSUtil::Decrypt_AES_BASE64(lua_State* pLuaState)
{
	LuaGSUtil** ppGSUtil = (LuaGSUtil **)luaL_checkudata(pLuaState, 1, GS_UTIL_CLASS);
	if (ppGSUtil != NULL)
	{
...
int LuaGSUtil::LaunchAiSvcs(lua_State* pLuaState)
{
	LuaGSUtil** ppGSUtil = (LuaGSUtil **)luaL_checkudata(pLuaState, 1, GS_UTIL_CLASS);
	if (ppGSUtil == NULL)
	{
